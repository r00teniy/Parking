...
internal class DataImport
{
    ...
    public List<string> GetAllLayersContainingString(Transaction tr, string stringToFind, string xRef = null)
    {
        Database db = Application.DocumentManager.MdiActiveDocument.Database;
        List<string> output = new();

        LayerTable lt = (LayerTable)tr.GetObject(db.LayerTableId, OpenMode.ForRead);
        string fullStr = xRef != null ? xRef + '|' + stringToFind : stringToFind;
    ...
    public List<string> GetAllLayersContainingString(string stringToFind, string xRef = null)
    {
    ...
    public Point3d GetInsertionPoint(string str)
    {
    ...
    public LineWeight PromptForLineweight()
    {
    ...
    //Getting hatch pattern dialog, currently only works in 2021
    ...
    public string PromptForHatchPattern()
    {
        string sHatchType = "SOLID";
        bool bRet = acedHatchPalletteDialog(sHatchType, true, out IntPtr ptr);
        if (bRet)
